...
bot = TeleBot(token='5437420742:AAEZZPVPYHoXqXC8Str78WYun7x39h_8oEg', parse_mode='html') # создание бота
...
def start_command_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        text='Привет! 👋\nЯ могу проверить JSON и преобразовать его в красивый текст.\nВведи JSON в виде строки:', # текст сообщения
    )
